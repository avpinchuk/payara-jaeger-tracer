...
public class Endpoint implements org.apache.thrift.TBase<Endpoint, Endpoint._Fields>, java.io.Serializable, Cloneable, Comparable<Endpoint> {
   ...
   */
  public @org.apache.thrift.annotation.Nullable java.nio.ByteBuffer ipv6; // optional
   ...
   * Conventionally, when the service name isn't known, service_name = "unknown".
   */
  public Endpoint setService_name(@org.apache.thrift.annotation.Nullable java.lang.String service_name) {
    this.service_name = service_name;
    return this;
  }
  ...
  public Endpoint setIpv6(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer ipv6) {
