...
public class Annotation implements org.apache.thrift.TBase<Annotation, Annotation._Fields>, java.io.Serializable, Cloneable, Comparable<Annotation> {
  ...
  public Annotation setValue(@org.apache.thrift.annotation.Nullable java.lang.String value) {
    this.value = value;
    return this;
  }
   ...
   * rollup of all events (such as client requests to a service) by IP address.
   */
  public Annotation setHost(@org.apache.thrift.annotation.Nullable Endpoint host) {
    this.host = host;
    return this;
  }
