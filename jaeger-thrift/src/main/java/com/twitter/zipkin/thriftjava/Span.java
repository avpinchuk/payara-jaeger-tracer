...
public class Span implements org.apache.thrift.TBase<Span, Span._Fields>, java.io.Serializable, Cloneable, Comparable<Span> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<BinaryAnnotation> binary_annotations; // required
   ...
   * Conventionally, when the span name isn't known, name = "unknown".
   */
  public Span setName(@org.apache.thrift.annotation.Nullable java.lang.String name) {
    this.name = name;
    return this;
  }
  ...
  public Span setAnnotations(@org.apache.thrift.annotation.Nullable java.util.List<Annotation> annotations) {
    this.annotations = annotations;
    return this;
  }
  ...
  public Span setBinary_annotations(@org.apache.thrift.annotation.Nullable java.util.List<BinaryAnnotation> binary_annotations) {
    this.binary_annotations = binary_annotations;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                @org.apache.thrift.annotation.Nullable Annotation _elem1;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                @org.apache.thrift.annotation.Nullable BinaryAnnotation _elem4;
      ...
      if (incoming.get(4)) {
        {
          ...
          @org.apache.thrift.annotation.Nullable Annotation _elem11;
      ...
      if (incoming.get(5)) {
        {
          ...
          @org.apache.thrift.annotation.Nullable BinaryAnnotation _elem14;
