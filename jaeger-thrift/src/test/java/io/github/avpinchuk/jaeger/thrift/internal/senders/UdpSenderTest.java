...
import io.github.avpinchuk.jaeger.thrift.internal.reporters.protocols.JaegerThriftSpanConverter;
import io.github.avpinchuk.jaeger.thrift.internal.reporters.protocols.TestTServer;
...
public class UdpSenderTest {
    ...
    private JaegerSpan buildSpanWithSize(int targetSpanSize) throws Exception {
        ...
        Span emptySpan = JaegerThriftSpanConverter.convertSpan(jaegerSpan);
    ...
    public void testAppend() throws Exception {
        ...
        JaegerSpan jaegerSpan = tracer.buildSpan("raza").start();
        Span span = JaegerThriftSpanConverter.convertSpan(jaegerSpan);
        ...
        // create a sender that a multiple of the span size (accounting for span overhead)
    ...
    public void testFlushSendsSpan() throws Exception {
        ...
        Span actualSpan = batch.getSpans().get(0);
