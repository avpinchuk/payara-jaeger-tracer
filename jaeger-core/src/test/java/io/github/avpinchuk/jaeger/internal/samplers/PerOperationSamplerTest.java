...
public class PerOperationSamplerTest {
    ...
    private final HashMap<String, GuaranteedThroughputSampler> operationToSamplers = new HashMap<>();
    ...
    public void setUp() {
        ...
        when(defaultProbabilisticSampler.sample(OPERATION, TRACE_ID)).thenReturn(
                SamplingStatus.of(true, new HashMap<>()));
    ...
    public void testPerOperationSamplerWithKnownOperation() {
        ...
        when(sampler.sample(OPERATION, TRACE_ID)).thenReturn(SamplingStatus.of(true, new HashMap<>()));
